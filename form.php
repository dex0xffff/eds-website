...
<li class='field_block' id='field_0_div'><div class='col_label'>
	<label class='form_field'>First & Last Name:</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
...
<li class='field_block' id='field_2_div'><div class='col_label'>
	<label class='form_field'># Guests:</label> <label class='form_required' >*</label> </div>
	<div class='col_field'>
	<?php phpfmg_radios( 'field_2', "1 Guest = 1,default|2 Guests = 2" );?>
	<div id='field_2_tip' class='instruction'></div>
	</div>
</li>

<li class='field_block' id='field_3_div'><div class='col_label'>
	<label class='form_field'>Guest #1's First & Last Name:</label> <label class='form_required' >&nbsp;</label> </div>
	<div class='col_field'>
...
<li class='field_block' id='field_4_div'><div class='col_label'>
	<label class='form_field'>Guest #2's First & Last Name:</label> <label class='form_required' >&nbsp;</label> </div>
	<div class='col_field'>
